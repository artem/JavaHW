   ...
   //   key6(password);
    ...
    private static void key4(final byte[] password) {
        //for (long i = Long.MIN_VALUE; i < Long.MAX_VALUE; i++) {
            //for (long i = 273381299L; i <= 5 * 273381299L + 10000000000000L; i++){
...
*/
    ...
    //private static final int SMALL_REPEAT_COUNT = 500;
    private static void key8(final byte[] password) {
        ...
        String s = repeated.toString();
        print(8, s.hashCode(), password);
    }
